...
def create_app():
    ...
    app.config['SECRET_KEY'] = '56e0968a5b5b532f19c871f9a7713cb0a5e1dcf17d1c3d5fcdf8e70486ff8826' #use your sceret key
    ...
    app.config['MAIL_DEFAULT_SENDER'] = ' '#your email id here
